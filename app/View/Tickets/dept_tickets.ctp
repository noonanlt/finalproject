...
Purpose: The index view for all tickets submitted to the logged in support staff's assigned department.
...
<div class="tickets index">
	<h2><?php echo __('Department Tickets'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
            ...
            <!-- allow user to delete if they are an admin-->
			<?php  if($userAuth==1) echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $ticket['Ticket']['ticket_number']), array(), __('Are you sure you want to delete # %s?', $ticket['Ticket']['ticket_number'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
